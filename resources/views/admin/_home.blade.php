...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-orange elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('assets/adminlte/dist/img/avatar.png')}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="#">GP-CBT</a>.</strong> All rights reserved.
  </footer>
