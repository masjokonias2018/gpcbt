...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="assets_landing/images/favicon.png" type="image/png">
    ...
    <!--====== Line Icons CSS ======-->
    <link rel="stylesheet" href="assets_landing/css/LineIcons.css">
    ...
    <!--====== Default CSS ======-->
    <link rel="stylesheet" href="assets_landing/css/default.css">
...
<body>
  ...
  <![endif]-->
    ...
    <header class="header-area">
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index.html">
                                <img src="assets_landing/images/logo.png" alt="Logo">
                            </a>
                            ...
                            <div class="d-none">
                                <a class="main-btn" data-scroll-nav="0" href="login"></a>
                            </div>
        ...
        <div id="home" class="header-hero bg_cover d-lg-flex align-items-center" style="background-image: url(assets_landing/images/header-hero.jpg)">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="about-image mt-60 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="assets_landing/images/about.png" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="our-services-image mt-50">
                                            <img src="assets_landing/images/our-service-1.jpg" alt="service">
                    ...
                    <div class="col-lg-4 col-md-7">
                        <div class="single-service d-flex">
                            <div class="service-icon">
                                <img src="assets_landing/images/service-1.png" alt="Icon">
                            </div>
                            ...
                            <div class="shape shape-1">
                                <img src="assets_landing/images/shape/shape-1.svg" alt="shape">
                            </div>
                            <div class="shape shape-2">
                                <img src="assets_landing/images/shape/shape-2.svg" alt="shape">
                            </div>
                        </div> <!-- single service -->
                    </div>
                    <div class="col-lg-4 col-md-7">
                        <div class="single-service service-border d-flex">
                            <div class="service-icon">
                                <img src="assets_landing/images/service-2.png" alt="Icon">
                            </div>
                            <div class="service-content media-body">
                            ...
                            <div class="shape shape-3">
                                <img src="assets_landing/images/shape/shape-3.svg" alt="shape">
                            </div>
                        </div> <!-- single service -->
                    </div>
                    <div class="col-lg-4 col-md-7">
                        <div class="single-service d-flex">
                            <div class="service-icon">
                                <img src="assets_landing/images/service-3.png" alt="Icon">
                            </div>
                            <div class="service-content media-body">
                            ...
                            <div class="shape shape-4">
                                <img src="assets_landing/images/shape/shape-4.svg" alt="shape">
                            </div>
                            <div class="shape shape-5">
                                <img src="assets_landing/images/shape/shape-5.svg" alt="shape">
                            </div>
                        </div> <!-- single service -->
                    </div>
                </div> <!-- row -->
        ...
        <div class="container">
            ...
            <div class="row grid">
                <div class="col-lg-4 col-sm-6 grid-item apps creative laptop">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="assets_landing/images/protfolio-1.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="assets_landing/images/protfolio-1.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item branding creative">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="assets_landing/images/protfolio-2.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="assets_landing/images/protfolio-2.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item apps branding product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="assets_landing/images/protfolio-3.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="assets_landing/images/protfolio-3.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item laptop product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="assets_landing/images/protfolio-5.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="assets_landing/images/protfolio-5.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item branding creative">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="assets_landing/images/protfolio-4.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="assets_landing/images/protfolio-4.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item apps laptop product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="assets_landing/images/protfolio-6.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="assets_landing/images/protfolio-6.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                        ...
                        <div class="testimonial-content-wrapper testimonial-active">
                                ...
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        <div class="author-image">
                                            <img src="assets_landing/images/author-1.jpg" alt="author">
                                        </div>
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        <div class="author-image">
                                            <img src="assets_landing/images/author-2.jpg" alt="author">
                                        </div>
                                        <div class="author-name media-body">
                                            <h5 class="name">John Doe</h5>
                                            <span class="sub-title">CEO, Alphabet</span>
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        <div class="author-image">
                                            <img src="assets_landing/images/author-3.jpg" alt="author">
                                        </div>
                                        <div class="author-name media-body">
                                            <h5 class="name">John Doe</h5>
                                            <span class="sub-title">CEO, Alphabet</span>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-blog mt-30 wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.4s">
                        <div class="blog-image">
                            <a href="blog-details.html"><img src="assets_landing/images/news-1.jpg" alt="news"></a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-blog mt-30 wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.7s">
                        <div class="blog-image">
                            <a href="blog-details.html"><img src="assets_landing/images/news-2.jpg" alt="news"></a>
                        </div>
                        <div class="blog-content">
                            <h4 class="blog-title"><a href="blog-details.html">Nulla eget urna at tortor  turpi feugiat tristique in sit.</a></h4>
                            <div class="blog-author d-flex align-items-center">
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-blog mt-30 wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="1s">
                        <div class="blog-image">
                            <a href="blog-details.html"><img src="assets_landing/images/news-3.jpg" alt="news"></a>
                        </div>
                        <div class="blog-content">
                            <h4 class="blog-title"><a href="blog-details.html">Nulla eget urna at tortor  turpi feugiat tristique in sit.</a></h4>
                            <div class="blog-author d-flex align-items-center">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="contact-wrapper-form pt-115  wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        ...
                        <form id="contact-form" action="assets_landing/contact.php" method="post">
                            <div class="row">
                                <div class="col-md-6">
    ...
    <footer id="footer" class="footer-area bg_cover" style="background-image: url(assets_landing/images/footer-bg.jpg)">
        <div class="container">
    ...
    <script src="assets_landing/js/vendor/modernizr-3.7.1.min.js"></script>
    ...
    <!--====== Isotope js ======-->
    <script src="assets_landing/js/imagesloaded.pkgd.min.js"></script>
    <script src="assets_landing/js/isotope.pkgd.min.js"></script>
    
    <!--====== Counter Up js ======-->
    <script src="assets_landing/js/waypoints.min.js"></script>
    <script src="assets_landing/js/jquery.counterup.min.js"></script>
    
    <!--====== Circles js ======-->
    <script src="assets_landing/js/circles.min.js"></script>
    
    <!--====== Appear js ======-->
    <script src="assets_landing/js/jquery.appear.min.js"></script>
    
    <!--====== WOW js ======-->
    <script src="assets_landing/js/wow.min.js"></script>
    
    <!--====== Headroom js ======-->
    <script src="assets_landing/js/headroom.min.js"></script>
    
    <!--====== Jquery Nav js ======-->
    <script src="assets_landing/js/jquery.nav.js"></script>
    
    <!--====== Scroll It js ======-->
    <script src="assets_landing/js/scrollIt.min.js"></script>
    
    <!--====== Magnific Popup js ======-->
    <script src="assets_landing/js/jquery.magnific-popup.min.js"></script>
